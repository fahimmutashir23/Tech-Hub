...
{/* tranding section */}
        ...
        <section className='px-10 mb-10 pt-10 pb'>
          <div>
          <h1 className='text-3xl font-semibold items-start pb-8 text-text_secondary'>Tranding Shop</h1> 
...
<h1 className='text-5xl font-semibold items-start pb-8 text-text_secondary pt-20 text-center'>WOO ! FLASH SALE</h1> 
<div className="flex flex-wrap ml-16 gap-x-32 pt-6 ">
  <div className="flex gap-3"><Link><p className="text-lg font-medium ml-18 text-text_secondary">Shop Now </p></Link>
  <Link><FaChevronRight className="text-text_secondary mt-2" /></Link>
  </div>
  ...
  <img className="w-52 pt-8" src={banner4} alt="" />
                   ...
                   {/* 1st adv */}
                   <div data-aos="fade-left" className="w-[50%] bg-green-100 px-10 py-20">

<h1 className='text-3xl font-semibold items-start pb-8 text-text_secondary'>Get Our <span className="text-red-600">Mobile App</span><br/>
It’s Make easy for you life !</h1>
...
{/* best seller section */}
         ...
         <section className='px-10 mb-10 pt-10 pb'>
          <div>
          <h1 className='text-3xl font-semibold items-start pb-8 text-text_secondary'>Best Seller</h1> 
          <div data-aos="fade-left"  className="pt-4 grid lg:grid-cols-6 md:grid-cols-2 sm:grid-cols-1 ">
          
            <div className=" ">
              <img className="w-[180px]  h-[180px]  rounded-xl  bg-slate-200" src={mobile3} alt="" />
              <h2 className='text-xl font-semibold items-center ml-10 pt-4 pb-8 text-text_secondary '>Quick Shop</h2> 
            </div>
            <div className=" ">
              <img className="w-[180px]  h-[180px]  rounded-xl  bg-slate-200" src={banner2} alt="" />
              <h2 className='text-xl font-semibold items-center ml-10 pt-4 pb-8 text-text_secondary '>Mobile Shop</h2> 
            </div>
            <div className=" ">
              <img className="w-[180px]  h-[180px]  rounded-xl  bg-slate-200" src={mobile1} alt="" />
              <h2 className='text-xl font-semibold items-center ml-10 pt-4 pb-8 text-text_secondary '>Smart Watch</h2> 
            </div>
            <div className=" ">
              <img className="w-[180px]  h-[180px]  rounded-xl  bg-slate-200" src={banner3} alt="" />
              <h2 className='text-xl font-semibold items-center ml-6 pt-4 pb-8 text-text_secondary '>Computer shop</h2> 
            </div>
            <div className=" ">
              <img className="w-[180px]  h-[180px]  rounded-xl  bg-slate-200" src={mobile2} alt="" />
              <h2 className='text-xl font-semibold items-center ml-10 pt-4 pb-8 text-text_secondary '>Quick Shop</h2> 
            </div>
            <div className=" ">
              <img className="w-[180px] h-[180px] rounded-xl  bg-slate-200" src={banner4} alt="" />
              <h2 className='text-xl font-semibold items-center ml-10 pt-4 pb-8 text-text_secondary '>Gaget Shop</h2> 
            </div>
...
{/* ad section */}
        ...
        <section className='lg:px-72 md:px-10 sm:px-10 mb-10 pt-10 pb'>
          <div data-aos="fade-right"  className="bg-text_secondary h-24 w-[800px] ">
          <p className='text-xl font-semibold items-start pb-2 text-white pt-6 px-20'>Get The Best Deal For Headphones </p> 
          <div className="flex gap-3 text-white px-20"><Link><p className="text-sm font-medium ml-18 text-white ">Shop Now</p></Link>
         <Link><FaChevronRight className="text-white mt-1" /></Link>
         </div>
