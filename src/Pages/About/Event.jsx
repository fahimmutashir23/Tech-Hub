...
const Event = () => {
    ...
    const targetDate = "2024-06-20T23:59:59";
      ...
      <section className=" mb-10 ">
        <div data-aos="fade-up" data-aos-duration="1000">
          ...
          <div className="flex flex-col lg:flex-row gap-gap_primary  p-6">
            <img className="w-72 " src={offer1} alt="" />
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full lg:w-[70%] gap-6 text-center">
              ...
              <div className="bg-white shadow-xl p-4 ">
                ...
                <img className="w-full h-full object-cover" src={offer2} alt="" />
                </div>
              ...
              <div className="bg-white shadow-xl p-4 ">
                <div className="h-[70%] w-full overflow-hidden">
                <img className="w-full h-full object-cover" src={offer3} alt="" />
                </div>
              ...
              <div className="bg-white shadow-xl p-4 ">
                <div className="h-[70%] w-full overflow-hidden">
                <img className="w-full h-full object-cover" src={offer4} alt="" />
                </div>
...
{/* ad section */}
      <section className="mb-10 pt-10 pb">
        <div
          data-aos="fade-up"
          className="bg-text_secondary h-24 w-full text-center "
        >
          <p className="text-xl font-semibold items-start pb-2 text-white pt-6 px-20">
            ...
            <Link>
              <p className="text-sm font-medium ml-18 text-white text-center ">Shop Now</p>
            </Link>
