...
const UpdateProfile = ({data, fetchData, isOpen, setIsOpen, setLoader }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axiosSecure.patch(`/api/profile-update`, formData);
      if (res.data.success) {
        fetchData();
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-gap_primary m-4">
                        ...
                        <div className="form-control">
                          ...
                          <textarea name="address" defaultValue={data?.address} className="p-2 border border-gray-700 rounded-sm focus:outline-none focus:border-2 focus:border-gray-700" id=""></textarea>
                        </div>
                        <div className="form-control">
                          <label className="label">
