...
{/* products ad section */}
          ...
          <div className="h-[40%] overflow-hidden">
              <img className="h-full min-w-52 object-content p-10" src={add3} alt="" />
              </div>
          </div>    
          {/* 1st adv */}
          <div data-aos="fade-right" className="lg:w-[50%] bg-green-100 p-6">
              <div className="h-[60%] w-full overflow-hidden ">
              <img className="h-full w-full object-content p-10" src={add1} alt="" />
              </div>
              <p className="pt-6">
          ...
          <div data-aos="fade-left" className="lg:w-[50%] bg-green-100 p-6">
              <div className="h-[60%] w-full overflow-hidden">
              <img className="h-full w-full object-content p-10" src={add2} alt="" />
              </div>
              <p className="pt-6">
              E-commerce, short for electronic commerce, refers to the buying
              and selling of goods or services using the internet.
