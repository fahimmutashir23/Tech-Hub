...
const SaleInvoice = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 bg-white shadow-md rounded-md mt-8">
        ...
        <tbody>
          {data.products?.map((product) => (
            <tr key={product._id} className="border-t">
              ...
              <td className="py-2 text-center px-4">{product.unitPrice * product.quantity}</td>
            </tr>
          ))}
        </tbody>
      </table>
      ...
      <section className="mt-6">
        <div className="flex justify-end items-center">
          <div className="text-right">
            ...
            <p className="text-md font-semibold">Total: {data.totalAmount}/-</p>
          </div>
        </div>
      </section>
    </div>
